...
e em algum momento nos deparamos com as seguintes siglas: **AMD**, **CMJ**, **ESM**
ou **UMD**.
Sem mais delongas vamos ao que interessa, o que cada sigla dessas significa.

## Asynchronous Module Definition — AMD

AMD é uma sigla para Asynchronous Module Definition, e é um padrão que foi proposto
